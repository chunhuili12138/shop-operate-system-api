...
public abstract class BaseWalletTransactions<M extends BaseWalletTransactions<M>> extends Model<M> implements IBean {
	...
	public void setWalletId(java.math.BigInteger walletId) {
		set("wallet_id", walletId);
	}
	
	public java.math.BigInteger getWalletId() {
		return getBigInteger("wallet_id");
	}
